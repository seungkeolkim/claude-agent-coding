...
`projects/{name}/tasks/TASK-001.json`을 수동으로 작성합니다:
...
./run_agent.sh run planner --project my-app --task TASK-001 --dry-run

# 실제 실행
./run_agent.sh run planner --project my-app --task TASK-001

# subtask 지정 실행
./run_agent.sh run coder --project my-app --task TASK-001 --subtask TASK-001-1
