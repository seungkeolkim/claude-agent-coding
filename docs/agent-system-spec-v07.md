...
| `013-handoff-phase-2.0-web-chat.md` | Phase 2.0 Web Chat + PR 비동기 + PID 통일 핸드오프 | Phase 2.0 상세 |
...
| **테스트** | `tests/` (260개) | Unit/Integration/E2E + Web DB/Syncer + Lifecycle + PR Review + merge_pr/close_pr + Web Chat 테스트 |
