...
| `012-handoff-phase-2.1-pr-actions.md` | Phase 2.1+ PR 직접 머지/닫기 핸드오프 | Phase 2.1+ 상세 |
...
| `docs_history/agent-system-spec-v06.md` | v6 설계 (아카이브) | 참고 불필요 |
...
| **테스트** | `tests/` (206개) | Unit/Integration/E2E + Web DB/Syncer + Lifecycle + PR Review + merge_pr/close_pr 테스트 |
