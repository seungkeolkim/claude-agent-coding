...
| `docs_history/handoffs/008~016-*.md` | Phase 1.5~2.2 완료 핸드오프 (아카이브, v07 §15.1에 통합됨) | 참고용 |
...
| **테스트** | `tests/` (212개) | Unit/Integration/E2E + Web DB/Syncer + Lifecycle + PR Review + merge_pr/close_pr + Web Chat + graceful shutdown/resume + safety limiter + priority queue 테스트 |
