...
- `scripts/` — init_project, agent 기동 래퍼, chatbot, hub_api, web
- `scripts/hub_api/protocol.py` — Protocol layer (Request/Response, dispatch)
- `scripts/chatbot.py` — Chatbot 대화형 인터페이스
- `scripts/web/` — Web Monitoring Console (FastAPI + SQLite + SPA)
...
# Task Manager + Web Console 시작 (백그라운드)
...
- 상세 명세를 위해 `docs/agent-system-spec-v07.md`를 읽으세요.
